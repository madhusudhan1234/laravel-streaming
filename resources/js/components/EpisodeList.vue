                            ...
                            <div class="mb-3 flex items-start justify-between">
                                ...
                                <div class="ml-4 flex items-center space-x-2">
                                    <button
                                        ...
                                        class="action-btn group rounded-full p-3 text-gray-400 transition-all duration-200 hover:bg-orange-50 hover:text-orange-500 focus:ring-2 focus:ring-orange-200 focus:outline-none"
